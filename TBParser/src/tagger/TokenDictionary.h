...
class Pipe;
// LPK: Here we map the features to their numerical representation to save space. This is an engineering choice.
// Dictionary seems like a collection of the "Alphabet", which is more like a hastable in Java implementation.
// LPK_TODO: If we want to add new features, we should also create the numerical representations here for them.

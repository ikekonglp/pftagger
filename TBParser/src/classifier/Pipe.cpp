...
void Pipe::CreateInstances() {
  ...
  while (instance) {
	// LPK: From this moment, the instance has been formatted to Numeric ones using
	// the GetFormattedInstance() method in DependencyPipe
    AddInstance(instance);
    // LPK: Refers to The method *DependencyReader::GetNext()
